...
int main( )
{
    Money yourAmount(13,19), myAmount(13, 99), purse(100,10);
    cout << "Enter an amount of money: ";
    //cin >> yourAmount;
    cout << "Your amount is " << yourAmount << endl;
    cout << "My amount is " << myAmount << endl;
    
    cout << purse.percent(10) << endl;
...
//calling object.
{
    int allCent = cents + dollars * 100;
    allCent *= percentFigure * 0.01;
    int centPart = allCent % 100;
    int dollarPart = allCent / 100;
    
    return Money(dollarPart,centPart);
}
